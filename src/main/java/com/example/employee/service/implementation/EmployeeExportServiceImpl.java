...
public class EmployeeExportServiceImpl implements EmployeeExportService {
  ...
  public void exportToExcel(String department, Boolean active, HttpServletResponse response) {
    try (XSSFWorkbook workbook = buildSheet(department, active)) {
//  ---------------- RESPONSE HEADERS ----------------
...
//  ---------------- WRITE OUTPUT ----------------
  ...
  public byte[] sendExcelToMail(String department, Boolean active) {
    try (ByteArrayOutputStream out = new ByteArrayOutputStream();
      Workbook workbook = buildSheet(department, active)) {
        workbook.write(out);
...
//  ---------------- HELPER ----------------
  ...
  private XSSFWorkbook buildSheet(String department, Boolean active) {
